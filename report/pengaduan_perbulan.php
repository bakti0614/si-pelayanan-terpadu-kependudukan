...
<html>
    <head>
        <title>Cetak Data Pengaduan Penduduk Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA Pengaduan BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <tr>
                            ...
                            $sql = "SELECT * FROM pengaduan WHERE substr(tgl,1,7)='$ambilthn-$ambilbln'";
